...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=3000&pause=900&color=00F5FF&center=true&vCenter=true&multiline=true&repeat=true&width=780&height=100&lines=%3E+Booting+Leonardo.exe...;%3E+MSc+Software+Engineering+%40+FCUL%2C+University+of+Lisbon" alt="Typing SVG" />
</a>


<br/>

![Profile Views](https://komarev.com/ghpvc/?username=lixX-17&color=00F5FF&style=for-the-badge&label=SYSTEM+VISITS)
![GitHub followers](https://img.shields.io/github/followers/lixX-17?label=FOLLOWERS&style=for-the-badge&color=B892FF&logo=github)
...
institution: FCUL - Faculdade de Ciências, University of Lisbon
...
- P2P messaging app featuring E2EE via SSL Sockets, mTLS, ECDHE key exchange, and RSA authentication.
- Multicloud storage (AWS, Firebase, Azure) secured by Shamir's Secret Sharing (8/12 threshold) and AES-256-GCM.
...
- Analyzed and exploited vulnApp and SSS-DB, identifying vulnerabilities such as buffer overflows, SQL injections, XSS, and command injection.
- Performed manual code auditing, exploit development, proxy testing, static analysis, fuzzing, and LLM-assisted checks.
...
- Designed unit test suites using ISP (Base Choice), Control/Data Flow (Prime Path, All-DU-Paths), and Logic Coverage.
- Utilized JUnit QuickCheck for Property-Based Testing and PIT to evaluate mutation score and structural robustness.
...
- Developed a DeFi app on Ethereum for token swapping (ETH/DEX) and collateralized loans.
- Co-implemented smart contracts and client-side development.
